                    ...
                    @foreach($services as $key => $value)
                        <tr>
                            ...
                            <td class="table-actions no-stretch">
                                ...
                                <a class="btn show-btn" data-toggle="tooltip" data-placement="bottom" title="View position" href="{{ URL::to('services/' . $value->id) }}">
                                    <i class="fa fa-user fa-lg"></i>
                                </a>

                                <!-- edit this employee (uses the edit method found at GET /employees/{id}/edit -->
                                <a class="btn edit-btn" data-toggle="tooltip" data-placement="bottom" title="Edit position" href="{{ URL::to('services/' . $value->id . '/edit') }}">
